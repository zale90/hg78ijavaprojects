...
public class Sudoku2 extends JFrame implements ActionListener,MouseListener
{
  ...
  public Sudoku2(Spiel spiel)
  {
    ...
    Icon bild = new ImageIcon("files/minigames/Sudoku/sudokuBildFenster.jpg");
    ...
    for(int i = 0; i <= 19;i++ )
    {
      if(i == 0 || i == 3 || i == 6 || i == 9 || i == 10 || i == 13 || i == 16 || i == 19)
      {
      }
      else
      {
  ...
  private void festeZahlen()
  {
    for(int i = 0; i <= 80; i++)
    {
      if(textfeld.get(i).getText().equals(""))
      {
        ...
        ((AbstractDocument) textfeld.get(i).getDocument()).setDocumentFilter(new DocumentSizeFilter(MAX, "[1-9]"));
      }
      else
      {
        textfeld.get(i).setForeground(new Color(50,225,200)); //20,180,225   50,225,200
...
//    while(i <= 80)
//    {
//      if(textfeld.get(i).getText().equals(muster.sudokuLösungPrüfen(i,r)))
//      {
//        if(i == 80)
//        {
