...
public class FensterFehler extends JFrame implements ActionListener,
		MouseListener {

	private static final long serialVersionUID = 2019774865074784563L;
	...
	public FensterFehler(String test) {
		...
		lbl3 = new JLabel("Tipp: Überprüfen Sie doch zunächst einmal Feld"
				+ " " + test);
		lbl3.setSize(290, 20);
