...
public class Fragensammlung
{
  ...
  // Ende Attribute
       ...
       bewerbung.add(new Frage("Wer war(en) bei der Bundestagswahl 2009 der/die Spitzenkandidat(en) der Grünen? ","1.) Ethen und Heptin","2.) Amadeus und Schneider","3.) Künast und Trittin","4.) Fischer",3));
       ...
       bewerbung.add(new Frage("Was ist das flächenmäßig größte Land der Welt? ","1.) USA","2.) China","3.) Russland","4.) Kanada",3));
       ...
       bewerbung.add(new Frage("Ein PS ist wie viel KW? ","1.) 0,56","2.) 0,74 ","3.) 0,96","4.) 1,34",4));
