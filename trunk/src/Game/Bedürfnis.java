...
public class Bedürfnis {
	 ...
	 * 
	 * Name: 0 = Nahrung 1 = Gesundheit 2 = Soziales 3 = Luxus 4 = Kinder
	 * 
	 * @param name
	 *            Name des Bedürfnisses. Es können die Konstanden NAHRUNG,
	 *            GESUNDHEIT, SOZIALES, LUXUS und KINDER benutzt werden.
	 * @param wert
	 *            Anfangswert
	 * @param min
	 *            Minimalwert
	 ...
	 *            Maximalwert
	 * @param abfallfaktor
	 *            Faktor um den der Wert bei jeder Runde reduziert werden soll.
	 */
	...
	/**
	 * Setzt den Wert des Bedürfnisses. Dieser kann jedoch nicht größer als das
	 * Maximum oder kleiner als das Minimum werden.
	 * 
	 * @param wert
	 *            Der neue Wert.
	 */
