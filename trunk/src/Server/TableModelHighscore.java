...
public class TableModelHighscore extends AbstractTableModel {
	 ...
	 * 
	 * @param scores Highscores aus denen das Model erstellt werden soll.
	 */
	 ...
	 * Dabei wird höchstens 10 zurückgeliefert. Bei niedrigeren Werten wird der aktuelle Wert zurückgegeben.
	 */
	...
	/**
	 * Gibt den Namen der gewünschten Spalte zurück.
	 * Entweter Punkte oder Name.
	 */
