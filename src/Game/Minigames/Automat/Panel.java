...
public class Panel extends JPanel implements Runnable
{
  ...
  public Panel(int wait)
  {
   ...
   kirsche = new JLabel(new ImageIcon("files/Minigames/Automat/kirsche.png"));
   ...
   try{
     while(laeuft){
       ...
       if(speed >= 5 && wait <= 10)
          ...
          apfel.setIcon(new ImageIcon("files/Minigames/Automat/apfel.png"));
          apfel.setSize(60,60);
          euro.setIcon(new ImageIcon("files/Minigames/Automat/€.png"));
          euro.setSize(60,60);
          banane.setIcon(new ImageIcon("files/Minigames/Automat/banane.png"));
          banane.setSize(60,60);
          kirsche.setIcon(new ImageIcon("files/Minigames/Automat/kirsche.png"));
          kirsche.setSize(60,60);
          glocke.setIcon(new ImageIcon("files/Minigames/Automat/glocke.png"));
          glocke.setSize(60,60);
       }
        this.updateUI();
        if(apfel.getY() > 180)
  ...
  private void setBild()
   {
       ...
       euro.setSize(42,74);
       banane.setIcon(new ImageIcon("files/Minigames/Automat/banane_blur.png"));
       banane.setSize(54,73);
       kirsche.setIcon(new ImageIcon("files/Minigames/Automat/kirsche_blur.png"));
       kirsche.setSize(60,73);
       glocke.setIcon(new ImageIcon("files/Minigames/Automat/glocke_blur.png"));
