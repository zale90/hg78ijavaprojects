...
public class Automat extends JFrame implements MouseListener, Runnable
{
   ...
   //Symbole
   private JLabel moegl, fruechte, sApfel, sEuro, sBanane, sKirsche, sGlocke, versuche, penny;
   private Thread threadL, threadM, threadR, automat;
   private int blinken, speed, score, stand, l, m, r, vs, guthaben;
   ...
   public Automat(int v, int ein, Kontrolle kontrolle)
   {
       ...
       gewonnenKasten = new JLabel(new ImageIcon("files/Minigames/Automat/kasten.png"));
       ...
       // Buttons erstellen
       stopL = new JLabel(new ImageIcon("files/Minigames/Automat/stop_button_deact.png"));
       stopL.setSize(60, 60);
       stopL.setLocation(125, 270);
       this.add(stopL);
       stopL.addMouseListener(this);
       
       stopM = new JLabel(new ImageIcon("files/Minigames/Automat/stop_button_deact.png"));
       stopM.setSize(60, 60);
       stopM.setLocation(190, 270);
       this.add(stopM);
       stopM.addMouseListener(this);
       
       stopR = new JLabel(new ImageIcon("files/Minigames/Automat/stop_button_deact.png"));
       stopR.setSize(60, 60);
       ...
       sApfel = new JLabel("X3>5€",new ImageIcon("files/Minigames/Automat/symbole/apfel.png"),0);
       ...
       sEuro = new JLabel("X3>10€",new ImageIcon("files/Minigames/Automat/symbole/€.png"),0);
       ...
       sBanane = new JLabel("X3>20€",new ImageIcon("files/Minigames/Automat/symbole/banane.png"),0);
       ...
       sKirsche = new JLabel("X3>50€",new ImageIcon("files/Minigames/Automat/symbole/kirsche.png"),0);
       ...
       sGlocke = new JLabel("X3>100€",new ImageIcon("files/Minigames/Automat/symbole/glocke.png"),0);
   ...
   public void run()
   {
     try{
      while(true){
       points.updateUI();
       Thread.sleep(25);
       if(left.getSpeed() == 0 && right.getSpeed() == 0 && mid.getSpeed() == 0 && !start.isEnabled()){
          if((left.getWinner() == 1 && mid.getWinner() == 3 && right.getWinner() == 4) ||
              (left.getWinner() == 1 && mid.getWinner() == 4 && right.getWinner() == 3) ||
              (left.getWinner() == 4 && mid.getWinner() == 1 && right.getWinner() == 3) ||
              (left.getWinner() == 4 && mid.getWinner() == 3 && right.getWinner() == 1) ||
              (left.getWinner() == 3 && mid.getWinner() == 4 && right.getWinner() == 1) ||
              (left.getWinner() == 3 && mid.getWinner() == 1 && right.getWinner() == 4) ||
              (left.getWinner() == 1 && mid.getWinner() == 1 && right.getWinner() == 3) ||
              (left.getWinner() == 1 && mid.getWinner() == 1 && right.getWinner() == 4) ||
              (left.getWinner() == 1 && mid.getWinner() == 3 && right.getWinner() == 1) ||
              (left.getWinner() == 1 && mid.getWinner() == 4 && right.getWinner() == 1) ||
              (left.getWinner() == 3 && mid.getWinner() == 1 && right.getWinner() == 1) ||
              (left.getWinner() == 4 && mid.getWinner() == 1 && right.getWinner() == 1) ||
              (left.getWinner() == 3 && mid.getWinner() == 3 && right.getWinner() == 1) ||
              (left.getWinner() == 3 && mid.getWinner() == 3 && right.getWinner() == 4) ||
              (left.getWinner() == 3 && mid.getWinner() == 1 && right.getWinner() == 3) ||
              (left.getWinner() == 3 && mid.getWinner() == 4 && right.getWinner() == 3) ||
              (left.getWinner() == 4 && mid.getWinner() == 3 && right.getWinner() == 3) ||
              (left.getWinner() == 4 && mid.getWinner() == 4 && right.getWinner() == 1) ||
              (left.getWinner() == 4 && mid.getWinner() == 4 && right.getWinner() == 3) ||
              (left.getWinner() == 4 && mid.getWinner() == 1 && right.getWinner() == 4) ||
              (left.getWinner() == 4 && mid.getWinner() == 3 && right.getWinner() == 4) ||
              (left.getWinner() == 1 && mid.getWinner() == 4 && right.getWinner() == 4) ||
              (left.getWinner() == 1 && mid.getWinner() == 3 && right.getWinner() == 3) ||
              (left.getWinner() == 3 && mid.getWinner() == 4 && right.getWinner() == 4)){
                if(score != 1){
                  score = 1;
                  stand = stand+score;
                }
                pktAkt.setText(String.valueOf(score)+"€");
                punkte.setText("Gewinn: "+ String.valueOf(stand)+"€");
                pktAkt.setLocation(195,135);
                blinke = true;
              }
          if(left.getWinner() == 1 && mid.getWinner() == 1 && right.getWinner() == 1){
             if(score != 5){
               score = 5;
               stand = stand+score;
             }
          ...
          if(left.getWinner() == 2 && mid.getWinner() == 2 && right.getWinner() == 2){
             if(score != 10){
               score = 10;
               stand = stand+score;
             }
          ...
          if(left.getWinner() == 3 && mid.getWinner() == 3 && right.getWinner() == 3){
             if(score != 20){
               score = 20;
               stand = stand+score;
             }
          ...
          if(left.getWinner() == 4 && mid.getWinner() == 4 && right.getWinner() == 4){
             if(score != 50){
               score = 50;
               stand = stand+score;
             }
          ...
          if(left.getWinner() == 5 && mid.getWinner() == 5 && right.getWinner() == 5 ){
             if(score != 100){
               score = 100;
               stand = stand+score;
             }
       ...
       if(left.getSpeed() != 0 && right.getSpeed() != 0 && mid.getSpeed() != 0){
          if(start.isEnabled())
            start.setEnabled(false);
          if(l == 0 && left.getSpeed() == 10 && !druck)
            stopL.setIcon(new ImageIcon("files/Minigames/Automat/stop_button.png"));
          else if(!druck)
            stopL.setIcon(new ImageIcon("files/Minigames/Automat/stop_button_deact.png"));
          if(m == 0 && mid.getSpeed() == 10 && !druck)
            stopM.setIcon(new ImageIcon("files/Minigames/Automat/stop_button.png"));
          else if(!druck)
            stopM.setIcon(new ImageIcon("files/Minigames/Automat/stop_button_deact.png"));
          if(r == 0 && right.getSpeed() == 10 && !druck)
            stopR.setIcon(new ImageIcon("files/Minigames/Automat/stop_button.png"));
          else if(!druck)
            stopR.setIcon(new ImageIcon("files/Minigames/Automat/stop_button_deact.png"));
       }
       ...
       if((!blinke && left.getSpeed() == 0 && right.getSpeed() == 0 && mid.getSpeed() == 0) && vs > 0){
         start.setEnabled(true);
   ...
   {
     if(evt.getSource() == stopL && left.getSpeed() == 10){
       stopL.setIcon(new ImageIcon("files/Minigames/Automat/stop_button_pressed.png"));
       druck = true;
     }
     if(evt.getSource() == stopM && mid.getSpeed() == 10){
       stopM.setIcon(new ImageIcon("files/Minigames/Automat/stop_button_pressed.png"));
       druck = true;
     }
     if(evt.getSource() == stopR && right.getSpeed() == 10){
       stopR.setIcon(new ImageIcon("files/Minigames/Automat/stop_button_pressed.png"));
       druck = true;
     }
   }
