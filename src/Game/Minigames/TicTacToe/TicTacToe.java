...
public class TicTacToe extends JFrame implements Runnable, ActionListener,
	...
	private ImageIcon hintergrund, hintergrund1, hintergrund2, schwamm;
	private JLabel hin, hin1, hin2, start, start2, ende, ende2, text, schw, x1,
			x2, x3, x4, x5, x6, x7, x8, x9, o1, o2, o3, o4, o5, o6, o7, o8, o9,
			cpupl, plcpu, hauptmenu, hauptmenu2, schwierigkeit, einfach,
			normal, schwer, soundTaste, soundTaste2, statusText, strichSenk,
			strichWag, strich1_9, strich3_7, level, cpu, pl, draw;
	...
	public TicTacToe() {
		...
		ImageIcon soundIcon = new ImageIcon(
				"files/minigames/TicTacToe/sound.png");
		...
		ImageIcon soundIcon2 = new ImageIcon(
				"files/minigames/TicTacToe/sound2.png");
		...
		ImageIcon startButton = new ImageIcon(
				"files/minigames/TicTacToe/start.png");
		...
		ImageIcon startButton2 = new ImageIcon(
				"files/minigames/TicTacToe/start2.png");
		...
		ImageIcon endeButton = new ImageIcon(
				"files/minigames/TicTacToe/ende.png");
		...
		ImageIcon endeButton2 = new ImageIcon(
				"files/minigames/TicTacToe/ende2.png");
		...
		ImageIcon strichSeknrecht = new ImageIcon(
				"files/minigames/TicTacToe/strichSenk.png");
		strichSenk = new JLabel(strichSeknrecht);
		strichSenk.setLocation(190, 40);
		strichSenk.setSize(strichSeknrecht.getIconWidth(), strichSeknrecht
				.getIconHeight());
		strichSenk.setVisible(false);
		this.add(strichSenk);

		ImageIcon strichWaagerecht = new ImageIcon(
				"files/minigames/TicTacToe/strichWag.png");
		strichWag = new JLabel(strichWaagerecht);
		strichWag.setLocation(80, 265);
		strichWag.setSize(strichWaagerecht.getIconWidth(), strichWaagerecht
				.getIconHeight());
		strichWag.setVisible(false);
		this.add(strichWag);

		ImageIcon strichEinsBisNeun = new ImageIcon(
				"files/minigames/TicTacToe/strich1-9.png");
		strich1_9 = new JLabel(strichEinsBisNeun);
		strich1_9.setLocation(-80, -100);
		strich1_9.setSize(strichEinsBisNeun.getIconWidth(), strichEinsBisNeun
				.getIconHeight());
		strich1_9.setVisible(false);
		this.add(strich1_9);

		ImageIcon strichDreiBisSieben = new ImageIcon(
				"files/minigames/TicTacToe/strich3-7.png");
		strich3_7 = new JLabel(strichDreiBisSieben);
		strich3_7.setLocation(-135, -85);
		strich3_7.setSize(strichDreiBisSieben.getIconWidth(),
				strichDreiBisSieben.getIconHeight());
