...
public class Abschluss extends JFrame implements ActionListener, MouseListener
{
  ...
  public void actionPerformed(ActionEvent e)
  {
    if(e.getSource() == ok)
    {
      ...
      {
        infos[0] = new Information(Information.AENDERN_GELD, Information.ART_UM_WERT, 20);
        SudokuFenster1.getSpiel().minispielEnde(infos);
      }
      else if(SudokuFenster1.getPreis().equals("50"))
      {
        infos[0] = new Information(Information.AENDERN_GELD, Information.ART_UM_WERT, 50);
        SudokuFenster1.getSpiel().minispielEnde(infos);
      }
      else
      {
        infos[0] = new Information(Information.AENDERN_GELD, Information.ART_UM_WERT, 100);
        SudokuFenster1.getSpiel().minispielEnde(infos);
      }
