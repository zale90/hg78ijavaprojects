...
public class Kniffel extends JWindow implements  MouseListener, Minispiel, ActionListener{
	...
	private void endeZweiterWurf() 
	{
		...
		{
				erklärung.setText("Du hast verloren und dein Einsatz ist weg!\nVersuch dein Glück doch noch einmal!");
				tfEinsatz.setText("0");
		...
		{
			erklärung.setText("Du hast eine kleine Straße und du bekommst deinen Einsatz\n zurück! Versuch dein Glück doch noch einmal!");
			tfEinsatz.setText("0");
			tfBargeld.setText(bargeld + einsatz +"");
		}
		...
		{
			erklärung.setText("Du hast eine große Straße und du bekommst den doppelten\n Einsatz zurück! Versuch dein Glück doch noch einmal!");
			tfEinsatz.setText("0");
			tfBargeld.setText(bargeld + einsatz + einsatz+"");
		}
		if(sechs == true && zwei == true && drei == true && vier == true && fünf == true)
		{
			erklärung.setText("Du hast eine große Straße und du bekommst den doppelten\n Einsatz zurück! Versuch dein Glück doch noch einmal!");
			tfEinsatz.setText("0");
			tfBargeld.setText(bargeld + einsatz + einsatz+"");
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getSource() == btnAktion && zustand == Zustand.Start && btnAktion.isEnabled()) 
		{
		...
		else if(e.getSource() == btnAktion && zustand == Zustand.Wurf1 && btnAktion.isEnabled()) {
		...
		else if(e.getSource() == btnAktion && zustand == Zustand.Wurf2 && btnAktion.isEnabled()) {
			reset();
		}
		else if(e.getSource() == btnbeenden && btnbeenden.isEnabled()) 
		{
			...
			Information[] infos = {
					new Information(Information.AENDERN_GELD, Information.ART_AUF_WERT, geldInt)
			};
			this.setVisible(false);
	...
	public void start(Spiel spiel) {
		...
		tfBargeld.setText(bargeld + "");
		Kniffel kniffelSpiel = new Kniffel();
	}
}