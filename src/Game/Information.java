...
public class Information {
	...
	/**
	 * Setzt den Wert auf den übergebenen Wert fest. Dies geschieht unabhängig
	 * vom aktuellen Wert.
	 */
	public static final int ART_AUF_WERT = 1;
	/**
	 * Addiert den neuen Wert auf den aktuellen Wert drauf. Um einen Wert
	 * abzuziehen, muss ein negativer Wert übergeben werden.
	 */
	public static final int ART_UM_WERT = 2;
	/**
	 * Setzt den Wert auf einen bestimmten Prozentsatz fest. Dies geschieht
	...
	/**
	 * @param zuÄndern
	 *            Gibt den den Wert an, der geändert werden sollte. Dabei können
	 *            alle Konstanten mit dem Anfang AENDERN_ benutzt werden.
	 * @param änderungsart
	 *            Gibt die Art der Änderung an. Dabei können die Konstanten mit
	 *            dem Anfang ART_ benutzt werden.
	 * @param wert
	 *            Der neue Wert.
	 */
