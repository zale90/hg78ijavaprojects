...
public class SpielAnwendung {
	 ...
	 * 
	 * @param av
	 *            Avatar für den das Spiel gestartet werden soll.
	 */
	...
	/**
	 * Beendet das aktuelle Spiel, fügt den übergebenen Highscore an der
	 * passenden stelle in die Highscoreliste ein und zeigt diese anschließend
	 * an.
	 * 
	 * @param avatarNr
	 *            Nr des Avatars für den die Liste angezeigt werden soll.
	 * @param avatarName
	 *            Name des Avatars für den die Liste angezeigt werden soll.
	 * @param score
	 *            Highscore der an der passenden Stelle in die vorher definierte
	 *            Highscoreliste eingefügt werden soll.
	 */
